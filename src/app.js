...
const reporteRoutes = require('./routes/reporteRoutes'); // Importar rutas del módulo de reportes
...
app.use('/api/reportes', reporteRoutes); // Registrar rutas del módulo de reportes
